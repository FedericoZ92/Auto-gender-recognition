...
option.ROI                  = [100 200 400 600];  % A rectangle [x, y, w, h] that limits the processing area to ground locations.
...
% Read the next video frame from the video file.
    function frame = readFrame(ind)
        ...
        frame = imread(strcat('C:\Users\Federico\Desktop\DATASETS\++++Mall dataset\mall_dataset\frames\', 'seq_00', num2str( ind, '%04d' ), '.jpg'))
    end
