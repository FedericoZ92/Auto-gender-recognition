...
save([feats_dir '/FeatsNeg_' methods '.mat'], 'FeatsNeg');
model=train_save(FeatsPos, FeatsNeg,1,[bootstrap_1_methods],modeldir); %1 intersection, 2 chisquared, and 3 JS kernels
t3=toc;
%%%%%%%%%%%%%%%%% Bootstraping 2 %%%%%%%%%%%%%%%%%%%%
tic;
nmax_param.th=0.0;
...
FeatsNegHard=bootstrap(imgNegList,nori,border,strideh,stridew,scaleratio,model,nmax_param,hardfeatsdir,methods);
save([feats_dir '/FeatsNegHard_2_' methods result_comment '.mat'], 'FeatsNegHard');
t2=toc;
%%%%%%%%%%%%%%%%%% Retrainning Model%%%%%%%%%%%%%%%%%%%%
if(~exist('FeatsNegHard','var'))
...
FeatsNeg=[FeatsNeg;FeatsNegHard];
save([feats_dir '/FeatsNeg_' methods '.mat'], 'FeatsNeg');
model=train_save(FeatsPos, FeatsNeg,1,[bootstrap_2_methods],modeldir); %1 intersection, 2 chisquared, and 3 JS kernels
t3=toc;
%%%%%%%%%%%%%%%%% Bootstraping 3 %%%%%%%%%%%%%%%%%%%%
tic;
nmax_param.th=0.0;
...
FeatsNegHard=bootstrap(imgNegList,nori,border,strideh,stridew,scaleratio,model,nmax_param,hardfeatsdir,methods);
save([feats_dir '/FeatsNegHard_3_' methods result_comment '.mat'], 'FeatsNegHard');
t2=toc;
%%%%%%%%%%%%%%%%%% Retrainning Model%%%%%%%%%%%%%%%%%%%%
if(~exist('FeatsNegHard','var'))
...
FeatsNeg=[FeatsNeg;FeatsNegHard];
save([feats_dir '/FeatsNeg_' methods '.mat'], 'FeatsNeg');
model=train_save(FeatsPos, FeatsNeg,1,[bootstrap_3_methods],modeldir); %1 intersection, 2 chisquared, and 3 JS kernels
t3=toc;
