...
#GLOBAL SETTINGS
homedir = '/home/zanetti/FINAL_PIPELINE_extended_renamed3/' #people_automatic2100_cleanup2/' #people_nonpeople4/' #people_automatic20000_extended/' #people_automatic9000_cleanup_extended/' #M_F_nonpeople/' #people_automatic2100_cleanup2/'   # ##MIT_dataset_even/'#3fold_Full_set1/'#Main directory of dataset
...
num_epochs_ = 20 #Times all images are forward-propagated.
batch_size = 16
image_size_h = 64
image_size_w = 32
crop_size_h = 64 #Images are re-sized to crop_size x crop_size.
crop_size_w = 32
...
toLoadWeights = False #To resume training from previous state.
weights_name = 'weights_FINAL_PIPELINE_extended_renamed3_ep._4_acc._72.7810650888' #all entire file name without .npz, name of weights to load
save_weights = 1 #at 1 to save weights each epoch.
simulation_name = 'FINAL_PIPELINE_extended_renamed3_test2.2'#'43cl._1ite_segm'#'std_43cl_10ite_32x32_halveall_fcl256' #To be changed every time architecture or data changes to save the weights. 
...
show_confusion_matrix = 0 #at 1 to show confusion matrix.
