classdef PeopleDetector_fede2 < matlab.System 
    %C'è anche una funzione a cui cambiare il nome a riga 193
    ...
    properties(Nontunable)
        ...
        ClassificationModel = 'UprightPeople_128x64'; %96x48';
    end
    ...
    methods
        ...
        % Constructor
        %------------------------------------------------------------------
        function obj = PeopleDetector_fede2(varargin)       
            if (isSimMode())
